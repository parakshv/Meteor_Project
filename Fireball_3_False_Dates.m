...
if site_num==1
    ...
    datasheet=Fireball_Detection_US000Y_Humstractor_Data_False_Dates;
elseif site_num==2
    load('Fireball_Detection_US0016_Humstractor_Data_False_Dates.mat')
    datasheet=Fireball_Detection_US0016_Humstractor_Data_False_Dates;
elseif site_num==3
    load('Fireball_Detection_US0015_Humstractor_Data_False_Dates.mat')
    datasheet=Fireball_Detection_US0015_Humstractor_Data_False_Dates;
end
