...
%     
%     if site_num==1
%         path1=append('E:\All_Meteor_Detections\us000Y\Figures\Spectrograms\',meteor_filename,'png');
%         saveas(fig1,[path1],'png');
%     
%         path2=append('E:\All_Meteor_Detections\us000Y\Figures\Spectrograms\',meteor_filename,'eps');
%         saveas(fig1,[path2],'eps');
%     
%         path3=append('E:\All_Meteor_Detections\us000Y\Figures\Spectrograms\',meteor_filename,'fig');
%         saveas(fig1,[path3],'fig');
%         
%     elseif site_num==2
%         path1=append('E:\All_Meteor_Detections\us0016\Figures\Spectrograms\',meteor_filename,'png');
%         saveas(fig1,[path1],'png');
%     
%         path2=append('E:\All_Meteor_Detections\us0016\Figures\Spectrograms\',meteor_filename,'eps');
%         saveas(fig1,[path2],'eps');
%     
%         path3=append('E:\All_Meteor_Detections\us0016\Figures\Spectrograms\',meteor_filename,'fig');
%         saveas(fig1,[path3],'fig');
%         
%     elseif site_num==3
%         path1=append('E:\All_Meteor_Detections\us0015\Figures\Spectrograms\',meteor_filename,'png');
%         saveas(fig1,[path1],'png');
%     
%         path2=append('E:\All_Meteor_Detections\us0015\Figures\Spectrograms\',meteor_filename,'eps');
%         saveas(fig1,[path2],'eps');
%     
%         path3=append('E:\All_Meteor_Detections\us0015\Figures\Spectrograms\',meteor_filename,'fig');
%         saveas(fig1,[path3],'fig'); 
%         
%     end
% end
...
%     
%     if site_num==1
%         path4=append('E:\All_Meteor_Detections\us000Y\Figures\Time Series\',meteor_filename,'png');
%         saveas(fig2,[path4],'png');
%     
%         path5=append('E:\All_Meteor_Detections\us000Y\Figures\Time Series\',meteor_filename,'eps');
%         saveas(fig2,[path5],'eps');
%     
%         path6=append('E:\All_Meteor_Detections\us000Y\Figures\Time Series\',meteor_filename,'fig');
%         saveas(fig2,[path6],'fig');
%         
%     elseif site_num==2
%         path4=append('E:\All_Meteor_Detections\us0016\Figures\Time Series\',meteor_filename,'png');
%         saveas(fig2,[path4],'png');
%     
%         path5=append('E:\All_Meteor_Detections\us0016\Figures\Time Series\',meteor_filename,'eps');
%         saveas(fig2,[path5],'eps');
%     
%         path6=append('E:\All_Meteor_Detections\us0016\Figures\Time Series\',meteor_filename,'fig');
%         saveas(fig2,[path6],'fig');
%         
%     elseif site_num==3
%         path4=append('E:\All_Meteor_Detections\us0015\Figures\Time Series\',meteor_filename,'png');
%         saveas(fig2,[path4],'png');
%     
%         path5=append('E:\All_Meteor_Detections\us0015\Figures\Time Series\',meteor_filename,'eps');
%         saveas(fig2,[path5],'eps');
%     
%         path6=append('E:\All_Meteor_Detections\us0015\Figures\Time Series\',meteor_filename,'fig');
%         saveas(fig2,[path6],'fig'); 
%         
%     end
% end
