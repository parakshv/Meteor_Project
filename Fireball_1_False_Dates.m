...
function [vlfsite,meteor_filename,new_segment,vlf_filename,cal_segment,cal_removed_noise_data,start_event,end_event,duration,start_event_error_bound,end_event_error_bound,juliandate_meteortrue,juliandate_vlffile,finalvlfdate_test,finalmeteortrue_test,No_Data]=Fireball_1_False_Dates(i,site_num)
...
day=str2num(string_start(9:10))+1;
